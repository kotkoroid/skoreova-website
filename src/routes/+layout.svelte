    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        <div class="flex items-center space-x-3">
          ...
          <!-- Header text as link -->
          <a href="/" class="text-xl font-semibold hover:text-blue-600 transition-colors">
            Skóreová
          </a>
        </div>
        ...
        <nav class="hidden md:flex space-x-8">
          <a href="/" class="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">Články</a>
          <a href="/about" class="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">Hráčky</a>
          <a href="/services" class="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">Něco</a>
          <a href="/contact" class="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">Kontakt</a>
        </nav>

        <!-- Social Icons -->
        <div class="flex items-center space-x-4">
          <a href="https://x.com" class="text-gray-700 hover:text-blue-600 p-2" aria-label="X (Twitter)">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="https://threads.net" class="text-gray-700 hover:text-blue-600 p-2" aria-label="Threads">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {#if mobileMenuOpen}
      <div class="md:hidden border-t border-gray-200">
        <nav class="px-4 pt-2 pb-4 space-y-1 bg-white">
          <a href="/" class="block px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md text-sm font-medium">Články</a>
          <a href="/about" class="block px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md text-sm font-medium">Hráčky</a>
          <a href="/services" class="block px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md text-sm font-medium">Něco</a>
          <a href="/contact" class="block px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md text-sm font-medium">Kontakt</a>
        </nav>
      </div>
    {/if}
  </header>
      ...
      <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <main class="lg:col-span-3 order-1 lg:order-1">
            <div class="bg-white shadow-lg rounded-lg mx-auto" style="width: 210mm; min-height: 297mm; max-width: 100%;">
          ...
          <aside class="lg:col-span-1 order-2 lg:order-2 sticky top-24 self-start">
            <div class="bg-white rounded-lg shadow p-6">
              ...
              <p class="text-gray-600 text-sm">Add your sidebar content here</p>
            </div>
          </aside>
        </div>
      </div>
